...
\noindent Estos son aquellos espacios donde la diferencia de potencial \(\bm{\nabla V}\) vale siempre cero, es decir, tienen el mismo potencial en todos los puntos. \\
...
\noindent Las cargas en un conductor tenderán a moverse, mientras circula un campo \(\bm{\vec{E}}\), hasta que la carga neta del sistema se estabilice y quede en equilibrio, alrededor de unos \(10^{-14}\) s.\\\\
...
\[
        E = \frac{\sigma_+-\sigma_-}{\epsilon_{\textnormal{o}}}
\]
